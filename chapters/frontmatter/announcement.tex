...
\centerline{\fontsize{21pt}{\baselineskip}\selectfont {\textbf{独创性声明}}}
\vspace*{0.5cm}
{\zihao{5}
{\baselineskip=1.56\baselineskip
...
\centerline{\fontsize{21pt}{\baselineskip}\selectfont {\textbf{关于论文使用授权的说明}}}
\vspace*{0.5cm}
{\zihao{5}
{\baselineskip=1.56\baselineskip
