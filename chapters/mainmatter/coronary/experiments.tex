...
\begin{figure}[h]
\centering
\includegraphics[width=2.0in]{Figures/coronary/ROI_Extraction}
...
\begin{figure}[htb]
\centering
\subfloat[]{\includegraphics[height=2.0in]{Figures/coronary/smooth}%
\label{fig:coronary_smoothing}}
\hfil
\subfloat[]{\includegraphics[height=2.0in]{Figures/coronary/threshold}%
...
\begin{figure}[htb]
\centering
\subfloat[]{\includegraphics[height=2.0in]{Figures/coronary/gradient}%
\label{fig:coronary_gradient}}
\hfil
\subfloat[]{\includegraphics[height=2.0in]{Figures/coronary/sigmoid}%
