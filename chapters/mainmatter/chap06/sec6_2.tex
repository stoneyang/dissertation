...
\begin{figure}[t]
\centering
\subfloat[]{\includegraphics[height=1.0in]{figures/chap06/artifact.eps}%
\label{fig:Artifact}}
\hfil
\subfloat[]{\includegraphics[height=1.0in]{figures/chap06/artifact_removed.eps}%
...
如图\ref{fig:FiveClasses}所示，所有的顶点被归为简单，复杂，以及拐角等三种类型。
...
对比这一过程前后的三角形面片的数量可知，对于一般简单顶点，边缘内部顶点，以及某些拐角顶点，减少了两个三角形面片；而对于边缘顶点的情形，只减少了一个三角形面片（见图\ref{fig:Reduction}）。