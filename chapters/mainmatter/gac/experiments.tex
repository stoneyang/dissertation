...
原始数据利用Siemens的SOMATOM Definition Flash CT来获取，该设备属于128排CT，图像帧间距为$0.6\text{mm}$，帧内分辨率达$0.4\text{mm} \times 0.4\text{mm}$，即体素规格为$0.4\text{mm} \times 0.4\text{mm} \times 0.6 \text{mm}$。
