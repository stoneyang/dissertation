...
\caption[虚拟训练系统样机的结构]{经皮冠状动脉介入术虚拟训练系统样机的结构。}
...
我们的训练系统样机运行于Windows\textsuperscript{\textregistered}操作系统之上\footnote{由于在研究与开发的过程中，我们所采用的软件工具和开发方式，该系统样机也可以移植到Linux操作系统上运行。}。
\begin{figure}[t]
\centering
