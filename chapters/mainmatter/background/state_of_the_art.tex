...
该系统利用了美国“可视人计划”（Visible Human Project, VHP）\footnote{Visible Human Project：\url{http://www.nlm.nih.gov/research/visible/}}的人体数据，通过与X光效果的解剖背景配准的仿真血管模型，向使用者提供实时的平面可视效果以及立体的导管导航\cite{Anderson1998daVinci}（见图\ref{fig1-1}）。%
...
为了解决这个问题，该团队的研究人员利用三次元量床（Coordinate Measuring Machine，CMM）\footnote{详见\url{http://en.wikipedia.org/wiki/Coordinate-measuring_machine}}来扫描冠状动脉的钢质模型\footnote{Kyoto Kagaku Co., Ltd.：\url{http://www.kyotokagaku.com/index.html}}，从而获得包括完整冠状动脉分支的仿真血管网络，再经过后期的细部处理，得到满足系统要求的冠状动脉血管模型\cite{Wang1998ICard}。%
...
位于美国麻省的三菱电气实验室（Mitsubishi Electric Research Laboratories，MERL）\footnote{Mitsubishi Electric Research Laboratories：\url{http://www.merl.com}}和美国创新微创疗法中心（Center for Innovative Minimally Invasive Therapy，CIMIT）\footnote{CIMIT：\url{http://www.cimit.org}}联合发起了ICTS项目\cite{Dawson2000ICTS,Cotin2000ICTS,Shaffer1999ICTS}。%
...
然而，当时的ICTS仅仅处于样机验证阶段，根据与比利时Guidant公司的合同，该项目后来被移交至英国Virtual Presence公司以完成系统的研发，并最终由瑞典Mentce公司将其商业化\cite{GuidantMenticeNewsWeb,coles2011surveyCRaIVE}，这就是该公司的VIST系列产品（见\ref{subsec:universal_intervention}。%
...
加拿大的CAE公司\footnote{CAE website：\url{http://www.cae.com}}开发了一种名为CathLabVR的仿真系统，用于心血管介入的训练。
...
CIMIT的Sim小组\footnote{The Sim Group, CIMIT：\url{http://www.medicalsim.org/home.php}}和法国INRIA的Shacra团队\footnote{Shacra team, INRIA：\url{https://team.inria.fr/shacra/}}联合开发的EVE项目\cite{Wu2005EVE}是一种用于仿真脑血管介入手术的系统。
...
\subsection{通用血管介入仿真系统}
\label{subsec:universal_intervention}

目前，VIST系列的两种仿真平台已经能够仿真的血管介入技术有：冠状动脉造影，心脏节律管理，跨室间隔穿刺，肾动脉介入，髂内动脉介入，膝关节以下血管介入，主动脉内窥修复，颈动脉介入，脑血管介入，子宫动脉栓塞术等\footnote{Mentice website：\url{http://www.mentice.com}}。%
...
以色列的Simbionix公司\footnote{Simbionix website：\url{http://www.simbionix.com}}研发了一种用于血管介入的仿真训练系统Angio Mentor。
...
美国的Medical Simulation公司开发了SimSuite\footnote{SimSuite website：\url{http://www.medsimulation.com}}系列血管介入手术仿真系统。
...
英国CRaIVE项目组（\textbf{C}ollaborators in \textbf{Ra}diological \textbf{I}nterventional \textbf{V}irtual \textbf{E}nvironments）\footnote{CRaIVE：\url{http://www.craive.org.uk}}进行了与介入手术的仿真训练相关的研究。%
