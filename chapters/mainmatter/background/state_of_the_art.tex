...
人类历史上最早出现的医学仿真器具大约出现于古美索不达米亚（约前$3100$～前$539$），由神庙里的祭司利用羊的肺和肝制成，主要用于教诲徒弟以及占卜未来\cite{Kunkler2006}。
...
Bosman等人研究了利用一种进化算法以替代面向特定问题的一阶解析估计算法，从而解决仿真过程中的优化问题的优劣，并证明采用前者更有利于系统性能的优化\cite{Bosman2005NKI}。
...
为获得NeuroCath系统所需的脑血管模型，Cai等人采用了一种利用扫描和混合操作以生成血管段和分岔的结构性方法，该方法提高了血管分岔处的光滑度\cite{Ye2002Vessel,Cai2003aVessel,Cai2003Vessel}；Volkau等人在此基础上提出了基于血管中心线的重建方法，该方法首先提高了血管中心线的光滑程度；其次抑制了在分割和骨架化过程中引入的噪声，从而提高了（重建血管时所依赖的）血管半径的精确度\cite{Volkau2005Vessel,Volkau2008Vessel}。%
...
为了获得X光的视觉效果，研究人员采用了一种“伪体绘制”的渲染方法\cite{Park1996GWU}，该方法能够生成影像数据的$360^\circ$视觉效果，并且支持虚拟场景中摄像头沿虚拟人体的径向移动。
