...
\hline
\bigstrut[t] \raisebox{30mm}{$\delta = 0.1$}  & \raisebox{-1mm}{\includegraphics[height=178pt]{Figures/centerlines/smooth_30_1_local.eps}}  & \includegraphics[height=178pt]{Figures/centerlines/smooth_30_01_local.eps}  \\
\hline
\bigstrut[b] \raisebox{30mm}{$\delta = 0.01$} & \raisebox{-3mm}{\includegraphics[height=178pt]{Figures/centerlines/smooth_100_1_local.eps}} & \raisebox{-3mm}{\includegraphics[height=178pt]{Figures/centerlines/smooth_100_01_local.eps}} \\
\hline
\end{tabular}
\caption[为平滑算法设置不同的参数所获得的结果]{为平滑算法设置不同的参数所获得的结果。（$N$：迭代次数；$\delta$：带宽）}
...
\begin{table}[t]
\renewcommand{\arraystretch}{0.5}
\caption[表面细分前后的多边形面片数量]{利用改进的butterfly策略进行表面细分前后的多边形面片数量。(a) 本章实验数据，细分后的多边形数量是细分前的$3.98$倍；(b) 完整的血管模型，细分后的多边形数量是细分前的$4$倍。}
\label{tbl:centerlins_subdivision}
\centering
\subfloat[][]{
