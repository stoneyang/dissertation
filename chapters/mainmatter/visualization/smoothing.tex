...
\begin{figure}[t]
\centering
\subfloat[]{\includegraphics[height=1.5in]{figures/visualization/artifact.eps}%
\label{fig:visualization_artifact}}
\hfil
\subfloat[]{\includegraphics[height=1.5in]{figures/visualization/artifact_removed.eps}%
