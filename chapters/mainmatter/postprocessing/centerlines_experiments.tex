...
\caption[实验用区段血管模型及其顶点连接性验证]{实验用区段血管模型及其顶点连接性验证：(a) 原始的主动脉下半段表面模型（由$205,590$个多边形构成）与VOI提取的模型局部（红色方框内）；(b) 血管表面模型的连接性验证结果（包含的多边形面片的数量：$70,625$）。}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=3.0in]{Figures/postprocessing/centerlines/subdivision.eps}
...
\hline
\end{tabular}
\caption[中心线提取的结果]{不同区段血管模型中心线的提取结果。}
\label{fig:centerlines}
% \end{table}
\end{figure}
% \begin{figure}[t]
% \centering
% \subfloat[]{\includegraphics[height=2.0in]{Figures/postprocessing/centerlines/overlay_100_01_voronoi_local.eps}%
% \label{fig:centerlins_voronoi_local}}
% \hfil
% \subfloat[]{\includegraphics[height=2.0in]{Figures/postprocessing/centerlines/overlay_100_01_centerlines_local.eps}%
...
% \begin{figure}[h]
% \centering
% \subfloat[]{\includegraphics[height=2.0in]{Figures/postprocessing/centerlines/overlay_100_01_voronoi.eps}
% \caption{Voronoi diagrams of the abdominal aorta.}
% \label{fig:centerlins_voronoi_global}}
% \hfil
% \subfloat[]{\includegraphics[height=2.0in]{Figures/postprocessing/centerlines/overlay_100_01_centerlines.eps}
