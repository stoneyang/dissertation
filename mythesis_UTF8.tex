...
\fancyhead[CE]{\CJKfamily{fs}基于三维模型的物体识别} %设置偶数页页眉
\include{Body/chap01_UTF8}
\include{Body/chap02_UTF8}
\include{Body/chap03_UTF8}
\include{Body/chap04_UTF8}
\include{Body/chap05_UTF8}
\include{Body/chap06_UTF8}
\include{Body/chap07_UTF8}
...
\input{Reference/myreference_UTF8}
\bibliography{Reference/dependent_reference_UTF8}
