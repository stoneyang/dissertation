...
\begin{figure}[t]
\centering
\subfloat{\includegraphics[width=1.5in]{Figures/smooth_30_1_local.png}%
\label{fig:Smooth30-1Local}}
\hfil
\subfloat{\includegraphics[width=1.45in]{Figures/smooth_30_01_local.png}%
\label{fig:Smooth30-01Local}}
\hfil
\subfloat{\includegraphics[width=1.5in]{Figures/smooth_100_1_local.png}%
\label{fig:Smooth100-1Local}}
\hfil
\subfloat{\includegraphics[width=1.45in]{Figures/smooth_100_01_local.png}%
...
\begin{figure}[t]
\centering
\subfloat{\includegraphics[width=1.5in]{Figures/overlay_100_01_voronoi_local.png}%
\label{fig:VoronoiLocal}}
\hfil
\subfloat{\includegraphics[width=1.5in]{Figures/overlay_100_01_centerlines_local.png}%
