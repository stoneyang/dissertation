...
\node [above right] at (-2.1,11.25) {\tiny \fs \bf 二值阈值滤波};
\node [above right] at (-2.1,14.25) {\tiny \fs \bf 管状物体增强};
\node [above right] at (-2.1,17.25) {\tiny \fs \bf 二值阈值滤波};
\node [above right] at (-1.8,20.25) {\tiny \fs \bf ROI体数据};
